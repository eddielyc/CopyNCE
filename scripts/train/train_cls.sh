...
print_usage() {
    echo "Usage: train_cls.sh [option1] [option2] [option3] [option4] [option5]"
    ...
    echo "   option3 - CONFIG: path of config file of this experiment, the code will load config from 'core/configs/train/matching/{CONFIG}'."
    echo "   option4 - EVAL_CONFIG: path of eval config file, the code will load config from 'core/configs/eval/matching/{EVAL_CONFIG}'."
...
# set CONFIG
CONFIG="core/configs/train/matching/$3"
echo "Set CONFIG: ${CONFIG}"

# set EVAL_CONFIG
EVAL_CONFIG="core/configs/eval/matching/$4"
