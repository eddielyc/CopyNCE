...
from core.models import build_local_verification_paired_model_for_eval
from core.data.build import build_local_verification_data_for_matching_eval
...
def eval_cls(model, cfg, epoch=None):
    dataset, data_loader = build_local_verification_data_for_matching_eval(cfg)
...
def main():
    ...
    model, epoch = build_local_verification_paired_model_for_eval(cfg)
